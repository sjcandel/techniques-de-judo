<?php 
    $title = "Techniques de sacrifices - Techniques de Judo";
    $ogTitle = "Techniques de sacrifices - Techniques de Judo";
    $ogType = "video";
...
<div class="animated fadeInRight">
  ...
  <section>
    <div class="m-x-15">
      <h1 class="text-grey2 text-xxl uppercase weight-700">Techniques de sacrifice</h1>
      <h2 class="subtitle text-xl p-l-40">sutemi-waza</h2>
    </div>
  </section>
